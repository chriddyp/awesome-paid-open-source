...
- [Plotly.js](https://github.com/plotly/plotly.js) (MIT) is free for developers but offers [hosting, a data viz editor, and other products](https://plot.ly) built on top of the library. Features are also funded directly through [paid engagements](https://plot.ly/products/consulting-and-oem/).
